...
OpenAI, Anthropic, Google Gemini, Groq, Mistral, Together AI, and xAI today. Beyond chat completions, [embeddings](/embeddings) batches run on OpenAI, Mistral, and Google, and [image generation](/images) batches run on OpenAI, Google, and xAI. Amazon Bedrock and Vertex AI are on the roadmap (they need object-storage staging and cloud IAM auth).
