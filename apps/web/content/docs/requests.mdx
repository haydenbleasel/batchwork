...
`metadata` attaches free-form key/value pairs to the batch. It's forwarded on the
file-upload providers (OpenAI, Groq, Together AI, and Mistral) and ignored by the
inline ones (Anthropic, Google Gemini, xAI):
