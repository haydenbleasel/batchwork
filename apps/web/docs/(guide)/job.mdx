---
title: Jobs
description: batch() returns a BatchJob handle — poll status, wait for completion, stream results as they land, or cancel the batch before it finishes.
---
...
job.provider; // "openai" | "anthropic" | "google" | "azure" | "groq" | "mistral" | "together" | "xai"
