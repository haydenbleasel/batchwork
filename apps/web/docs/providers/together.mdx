...
Together also batches `/v1/audio/translations` (audio in any language → English text) via [`batch.translations()`](/docs/transcriptions#translations), using the same `method: "FILE"` line shape.
