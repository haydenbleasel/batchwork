---
title: Anthropic
description: Run batches on Anthropic's Message Batches API — requests sent as an inline JSON array with no file uploads, results streamed from a results_url.
---
