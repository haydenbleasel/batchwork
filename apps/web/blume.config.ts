...
export default defineConfig({
  ...
  description:
    "Unified batch API for AI providers — run thousands of LLM requests at ~50% cost across OpenAI, Anthropic, Gemini, Azure OpenAI, Groq, Mistral, Together AI, and xAI.",
  github: {
    branch: "main",
    dir: "apps/web/docs",
    owner: "haydenbleasel",
