...
// Brand marks (paths from vercel/ai-elements & simple-icons). fill follows
// currentColor; sizing is handled by the menu item's own svg styles.
const OpenAIIcon = () => (
...
const ClaudeIcon = () => (
  <svg aria-hidden="true" fill="currentColor" viewBox="0 0 12 12">
    <path
      clipRule="evenodd"
...
const CursorIcon = () => (
  <svg aria-hidden="true" fill="currentColor" viewBox="0 0 466.73 532.09">
    <path d="M457.43,125.94L244.42,2.96c-6.84-3.95-15.28-3.95-22.12,0L9.3,125.94c-5.75,3.32-9.3,9.46-9.3,16.11v247.99c0,6.65,3.55,12.79,9.3,16.11l213.01,122.98c6.84,3.95,15.28,3.95,22.12,0l213.01-122.98c5.75-3.32,9.3-9.46,9.3-16.11v-247.99c0-6.65-3.55-12.79-9.3-16.11h-.01ZM444.05,151.99l-205.63,356.16c-1.39,2.4-5.06,1.42-5.06-1.36v-233.21c0-4.66-2.49-8.97-6.53-11.31L24.87,145.67c-2.4-1.39-1.42-5.06,1.36-5.06h411.26c5.84,0,9.49,6.33,6.57,11.39h-.01Z" />
  </svg>
);

const V0Icon = () => (
  <svg aria-hidden="true" fill="currentColor" viewBox="0 0 147 70">
...
const SciraIcon = () => (
  <svg aria-hidden="true" fill="none" viewBox="0 0 910 934">
    <path
...
// Targets that take a natural-language prompt referencing the page's markdown.
const chatProviders: {
  name: string;
  icon: ReactNode;
  createUrl: (prompt: string) => string;
}[] = [
  {
    createUrl: (prompt) =>
  ...
  {
    createUrl: (prompt) =>
      `https://t3.chat/new?${new URLSearchParams({ q: prompt })}`,
    icon: <MessageCircle />,
    name: "T3 Chat",
  },
  {
    createUrl: (prompt) =>
      `https://scira.ai/?${new URLSearchParams({ q: prompt })}`,
    icon: <SciraIcon />,
    name: "Scira",
  },
  {
    createUrl: (prompt) =>
      `https://v0.app?${new URLSearchParams({ q: prompt })}`,
    icon: <V0Icon />,
    name: "v0",
  },
  {
...
interface PageActionsProps {
  ...
  markdownUrl: string;
  // Absolute URL so the chat targets can actually fetch the page.
...
export const PageActions = ({
  ...
  const prompt = `Read ${markdownAbsoluteUrl}, I want to ask questions about it.`;
