...
- 78f9a70: Type raw provider payloads as JSON instead of `unknown`.
...
- 03f4647: Bump runtime dependencies (`ai`, `p-map`, `standardwebhooks`) and the optional AI SDK provider packages to their latest versions.
